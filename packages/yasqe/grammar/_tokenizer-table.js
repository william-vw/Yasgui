module.exports = {
  table: {
    ...
    "*constructQuery": {
      CONSTRUCT: ["constructQuery", "*constructQuery"],
      $: [],
      VALUES: [],
    },
    "*dataBlockValue": {
    ...
    queryAll: {
      VALUES: ["*constructQuery", "valuesClause"],
      CONSTRUCT: ["*constructQuery", "valuesClause"],
    ...
    sparql11: {
      $: ["prologue", "queryAll", "$"],
      VALUES: ["prologue", "queryAll", "$"],
      CONSTRUCT: ["prologue", "queryAll", "$"],
